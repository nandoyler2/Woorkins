-- Create buckets if they don't exist and ensure they are public
...
-- Business owners can upload/update media under a folder named with their business_id
...
-- Users can upload/update media under a folder named with their profile_id
